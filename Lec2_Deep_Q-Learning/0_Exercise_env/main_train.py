...
new_working_directory = "C:/Users/carol/BHT_advanced_software_engineering_WiSe23/Lec2_Deep_Q-Learning/0_Exercise_env/"
...
def get_args():
    ...
    parser.add_argument("--num_iters", type=int, default=num_iterations)
